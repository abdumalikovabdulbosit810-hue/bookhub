import { Edit3, KeyRound, Lock, Plus, ShieldCheck, Trash2, Users } from "lucide-react";
  ...
  return (
    <main className="container-page py-8">
      ...
      <div className="mt-6 grid gap-3 md:grid-cols-4">
        {[
          ["Current role", user?.role ?? "guest", ShieldCheck],
          ["Users", "48,120", Users],
          ["Permissions", "6 active", KeyRound],
          ["Security", "CSRF + XSS controls", Lock]
